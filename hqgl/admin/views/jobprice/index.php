<div class="box">
    <div class="box-content">
        <div class="box-header">
            <a class="btn" href="<?php echo $this->createUrl('create');?>"><i class="fa fa-plus"></i>添加职务类型及其价格</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <label style="margin-right:50px;">
                                <span>职务价格：</span>
                                <input style="width:200px;" class="input-text" type="text" name="input_price" value="<?php echo Yii::app()->request->getParam('input_price');?>">
                            </label>
                        </td>
                        <td>
