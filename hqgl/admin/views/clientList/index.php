<div class="box">
    <div class="box-content">
        <div class="header">
            ...
            <a style="..." id="j-delete" class="btn" href="javascript:;"
               onclick="we.dele(we.checkval('.check-item input:checked'),deleteUrl);">
                <i class="fa fa-trash-o"></i>删除</a>
        </div>
        <!--box header end-->
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                <input type="hidden" name="r" value="<?php Yii::app()->request->getParam('r');?>">
                <label style="...">
                    <span>关键字:</span>
                    <input style="..." class="input-text" type="text" name="keywords"
        ...
        <div class="box-table">
            <table class="list">
                ...
                <tr>
                    ...
                    <th><?php echo $model->getAttributeLabel('delivery_time');?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $v->delivery_time;?></td>
